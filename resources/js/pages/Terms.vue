<template>
    <Navbar />
    <Content :title="$t('Terms of Service')">
        <template #content>
            <div class="legal__content">
                <div class="legal__card shadow-sm">
                    <p class="legal__updated">{{ $t('Last Updated') }}：2026-04-08</p>

                    <div class="legal__section">
                        <h2 class="legal__section-title">{{ $t('terms.Section1.Title') }}</h2>
                        <p>{{ $t('terms.Section1.Body') }}</p>
                    </div>

                <div class="legal__section">
                    <h2 class="legal__section-title">{{ $t('terms.Section2.Title') }}</h2>
                ...
                <div class="legal__section">
                    <h2 class="legal__section-title">{{ $t('terms.Section3.Title') }}</h2>
                    <p>{{ $t('terms.Section3.Body') }}</p>
                </div>

                <div class="legal__section">
                    <h2 class="legal__section-title">{{ $t('terms.Section4.Title') }}</h2>
                ...
                <div class="legal__section">
                    <h2 class="legal__section-title">{{ $t('terms.Section5.Title') }}</h2>
                    <p>{{ $t('terms.Section5.Body') }}</p>
                </div>

                <div class="legal__section">
                    <h2 class="legal__section-title">{{ $t('terms.Section6.Title') }}</h2>
                    <p>{{ $t('terms.Section6.Body') }}</p>
                </div>

                    <div class="legal__section">
                        <h2 class="legal__section-title">{{ $t('terms.Section7.Title') }}</h2>
                ...
                <div class="legal__contact">
                    ...
                    <RouterLink to="/about">{{ $t('Contact Us') }}</RouterLink>
                </div>
            </div>
        </template>
    </Content>
